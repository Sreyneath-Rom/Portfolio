<template>
    <div class="bg-white shadow-md fixed top-0 left-0 right-0 z-50">
        <nav class="h-16 w-full max-w-7xl mx-auto flex items-center justify-between px-4 md:px-8 gap-4">
            <!-- Left: Logo + Title -->
            <div class="flex items-center gap-4">
                <router-link to="/" class="flex items-center gap-2 hover:opacity-80 transition">
                    ...
                    <span class="text-xl md:text-2xl font-semibold text-yellow-600">Portfolio</span>
                </router-link>
            </div>
            ...
            <div class="hidden md:flex flex-1 justify-center">
                <div class="relative w-full max-w-xs">
                    <span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-sky-400">
                        search
                    </span>
                    ...
                    <span class="material-symbols-outlined absolute right-3 top-1/2 -translate-y-1/2 text-sky-400 cursor-pointer hover:text-sky-600">
                        mic
                    </span>
                </div>
            </div>
        ...
        <transition name="fade">
            <div v-if="showMobileMenu" class="md:hidden fixed inset-0 bg-black bg-opacity-40 z-50" @click="showMobileMenu = false">
                <div class="absolute top-0 right-0 w-5/6 max-w-xs h-full bg-white shadow-lg p-6 flex flex-col gap-6"
                         @click.stop>
