  ...
  <div class="about-root min-h-screen py-20 px-6 transition-colors duration-500" :class="themeClasses">
    ...
    <div class="max-w-4xl mx-auto">
      <div class="relative overflow-hidden rounded-3xl border border-white/20 bg-white/10 dark:bg-black/20 backdrop-blur-xl shadow-2xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-10">
        ...
        <div
          class="flex-shrink-0 relative w-44 h-44 md:w-56 md:h-56 rounded-3xl overflow-hidden shadow-2xl ring-4 ring-white/20 transition-all duration-700 hover:ring-rose-400 hover:scale-110 hover:shadow-2xl"
          style="isolation: isolate"
        >
          <span
            aria-hidden="true"
            class="absolute -inset-6 rounded-full opacity-80 animate-spin-slow"
            :style="glowStyle"
          ></span>
          <img
            :src="img1"
            ...
            loading="lazy"
            class="relative z-10 w-full h-full object-cover transition-transform duration-700 hover:scale-110"
        ...
        <div class="flex-1 text-center md:text-left space-y-7">
          <div>
            ...
            <p class="mt-3 text-xl font-medium animate-fadeIn">Full-Stack Developer</p>
            <p class="text-sm opacity-75 animate-fadeIn">Phnom Penh, Cambodia • Born in Siem Reap • Age 21</p>
          </div>

          <p class="text-lg leading-relaxed max-w-2xl opacity-0 animate-fadeIn">
          ...
          <div class="flex flex-wrap gap-3 justify-center md:justify-start">
            <span
              ...
              :key="skill"
              class="px-5 py-2.5 rounded-full text-sm font-bold shadow-lg border border-white/30 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:bg-gradient-to-r hover:from-yellow-400 hover:via-pink-500 hover:to-cyan-400"
            >
              {{ skill }}
            </span>
          </div>
          ...
          <div class="flex flex-col sm:flex-row gap-5 mt-10 justify-center md:justify-start">
            ...
            <a
              ...
              class="group inline-flex items-center gap-3 px-7 py-4 rounded-2xl font-bold text-lg border-2 border-current bg-white/5 hover:bg-white/20 transition-all duration-300"
            >
    ...
    <section class="mt-28 text-center">
      ...
      <div class="flex justify-center gap-10">
        ...
        >
          <div
            class="w-16 h-16 rounded-2xl flex items-center justify-center shadow-xl transition-transform duration-300 hover:scale-125 hover:-translate-y-2"
            :class="social.bg"
            style="background-size: 200% 200%; transition: background-position 0.5s;"
            @mouseover="e => e.currentTarget.style.backgroundPosition='right'"
            @mouseleave="e => e.currentTarget.style.backgroundPosition='left'"
          >
