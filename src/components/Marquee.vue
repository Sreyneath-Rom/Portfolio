<template>
  ...
  <div class="mt-8 space-y-4">
    ...
    <div
      class="marquee-container bg-white py-3 overflow-hidden relative rounded-lg"
    >
      <div
        class="marquee-content whitespace-nowrap animate-marquee text-gray-700 font-medium inline-block"
      >
        <img
    ...
    >
      <div
        class="marquee-content whitespace-nowrap animate-marquee-right text-gray-700 font-medium inline-block"
      >
        <img
